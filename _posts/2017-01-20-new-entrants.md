...
The domestic segment is more visible thanks to media attention and price comparison services. Here we now have around 50 licensed suppliers. Several of these (e.g. First Utility, Ovo and Ecotricity) are bone-fide "challenger brands". In the last year or so there has been an increasing number of new entrants into the GB energy supply market. Some of the key drivers have been:
...
Although new entrants are posting impressive growth figures and the Big 6 appear to be easy targets, it is not all plain sailing. In November 2016 we had [the first failure of a domestic energy supplier in the GB market in more than nine years][1] and now that [DCC is operationally live][201] the industry is almost ready to [cross a chasm][301].

## The Arc of Execution
Over their first 5 years, new entrants typically follow the three phase lifecycle illustrated below. This is the arc of execution which is a model devised by the well known silicon valley VC Geoffrey Moore.
...
Taking a broad view of the market is recommended during the invent stage. Many nuts and bolts details can be left until transitioning to the deploy phase. Topics to major on during the Invent Phase are: 
...
As well as getting appropriate people, technology, processes and partners into place. A new entrant will have to sign up to a number of licences and industry codes from Ofgem and other industry bodies.
...
It is important to pay attention to which metric is used to measure the size of a customer base. This is particularly relevant with software and operational service charges.

Sometimes we count the number of contracts and other times we count the number of meters. For example a domestic customer with dual fuel may incur double costs because they have a gas and an electricity meter. In some cases they may only incur one set of costs.
